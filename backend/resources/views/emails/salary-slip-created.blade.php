...
<head>
    ...
    <title>Slip Gaji Tersedia</title>
    <style>
        /* Tema Tritama Barber - Merah, Emas, Biru */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Security box dengan warna merah muda */
        .security-box {
            background: #fdf2f4;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Slip Gaji Tersedia</h1>
            <p class="subtitle">Slip gaji Anda untuk periode berikut telah dibuat dan siap diunduh</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $slip->total_customers }} orang</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Total Layanan</span>
                    <span class="info-value">{{ $slip->total_services }} layanan</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Status</span>
                    <span class="info-value">{{ $slip->status === 'draft' ? 'Menunggu Persetujuan' : ($slip->status === 'approved' ? 'Disetujui' : 'Dibayar') }}</span>
                </div>
            </div>
            ...
            <div class="security-box">
                ...
                <p class="security-text">
                    Demi keamanan data Anda, rincian nominal gaji hanya tersedia di slip gaji yang dapat diunduh dalam format PDF melalui dashboard.
                </p>
            </div>
        </div>
