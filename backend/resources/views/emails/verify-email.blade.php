...
<head>
    ...
    <title>Verifikasi Email - Tritama Barber</title>
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Expiry note dengan warna merah muda */
        .expiry-note {
            text-align: center;
            font-size: 13px;
            color: #78716c;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="subtitle">Klik tombol di bawah untuk mengaktifkan akun</p>
            ...
            <p class="expiry-note">
                <strong>Catatan:</strong> Link ini berlaku selama 60 menit.<br>
