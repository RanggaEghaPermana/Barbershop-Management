...
<head>
    ...
    <title>Password Berhasil Diubah - Tritama Barber</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="subtitle">✓ Berhasil mengubah password</p>
            ...
            <div class="success-box">
                ...
                <p class="success-text">Password Anda telah berhasil diubah</p>
                <p class="info-text">{{ $user->email }}</p>
            </div>
            
            <p class="message">
                Password akun Anda telah berhasil diperbarui. Silakan login dengan password baru Anda.
            </p>
